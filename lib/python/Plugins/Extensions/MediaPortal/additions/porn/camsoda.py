...
default_cover = "file://%s/camsoda.png" % (config.mediaportal.iconcachepath.value + "logos")
		...
		for node in jsondata["results"]:
			...
			if status != "offline" and status != "private":
				...
				if stream_name != "":
					...
					Image = 'https://tmd-cdn.camsoda.com/thumbs/' + stream_name + '/' + enc + '/' + tsize + '/null/' + Name + '.jpg'
					print Image
