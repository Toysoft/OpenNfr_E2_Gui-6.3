...
def NFR4XBootMainEx(source, target, installsettings, bootquest, zipdelete, getimagefolder, getMachineRootFile):
    ...
    list_two = ['mkdir -p ' + media_nfr_target + '/media' + dev_null,
                ...
                'cp /etc/wpa_supplicant.wlan0.conf ' + media_nfr_target + '/etc/wpa_supplicant.wlan0.conf' + dev_null,				
                'cp /etc/wpa_supplicant.ra0.conf ' + media_nfr_target + '/etc/wpa_supplicant.ra0.conf' + dev_null,				
